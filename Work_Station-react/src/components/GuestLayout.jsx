...
// Here is the header and the footer for non connected users
    ...
    <div className="flex flex-col h-screen">
      <header className="h-10 mb-2 mt-2 flex p-6 border justify-between items-center">
        ...
        <div>
          <Link
            to="/auth/signup"
            className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 m-1 border border-blue-700 rounded mb-2"
          >
            Sign-up
          </Link>
          <Link
